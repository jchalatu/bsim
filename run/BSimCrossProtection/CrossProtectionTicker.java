...
public class CrossProtectionTicker extends BSimTicker {
    ...
    public CrossProtectionTicker(BSim sim, ArrayList<CrossProtectionBacterium> bacA, ArrayList<CrossProtectionBacterium> bacB,
        ...
        CrossProtectionTicker.antibioticA = antibioticA;
        CrossProtectionTicker.antibioticB = antibioticB;
