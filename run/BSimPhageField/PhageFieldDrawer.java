...
public class PhageFieldDrawer extends BSimP3DDrawer{
    ...
    public PhageFieldDrawer(BSim sim, int width_pixels, int height_pixels, double pixel_to_um_ratio, 
        ...
        bac = bac_to_draw;
        PhageFieldDrawer.field = field;
        PhageFieldDrawer.c = c;
    }
