...
public class PhageFieldLogger extends BSimLogger {
    ...
    public PhageFieldLogger(BSim sim, String filename, ArrayList<PhageFieldBacterium> bac, double pixel_to_um_ratio) {
        super(sim, filename);
        this.bac = bac;
    ...
    public void before() {
        ...
        write(AreaShape_fields + "," + other_fields + "," + TrackObjects_fields + "\n");
    }
